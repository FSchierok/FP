...
In ${}^2\text{S}_{\sfrac{1}{2}}$ und ${}^2\text{P}_{\sfrac{1}{2}}$ ist $J={\sfrac{1}{2}}$ und daher $M_J$ auf $\pm \sfrac{1}{2}$ beschränkt. Daraus können drei Übergänge mit den folgenden Werten für $\Delta M$ resultieren:
\begin{description}
