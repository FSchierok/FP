...
Zur Kontrastmessung werden in diesem Versuch ein Polarisationsfilter und ein PBSC (siehe \ref{par:pbsc}) verwendet. Der Polarisationsfilter lässt nur den Anteil des Lichtes hindurch, welcher im Winkel $\theta$ zur horizontalen Achse liegt. Dadurch gilt für die Beträge der beiden Teilstrahlen, welche durch den PBSC entstehen, folgender Zusammenhang:
