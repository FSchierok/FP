...
data_X_selected = SelectKBest(score_func=f_regression, k=11).fit_transform(data_X, data_y) # k = 11 da dadurch höchstmöglicher Jaccard-Index von J = 0.936 bei 1 Nearest Neighbor
...
# Lernen und überprüfen mit k Nearest Neighbors
